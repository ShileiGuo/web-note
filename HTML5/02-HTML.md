...
```html
    <h3>--html5 新增的input type 类型--</h3>
    <fieldset>
    	<legend>input type 类型</legend>
    	<form action="">
    		<p>邮箱: <input type="email"></p>
    		<p>手机: <input type="tel"></p>
    		<p>数字: <input type="number" name=""></p>
    		<p>网址: <input type="url" name=""></p>
    		<p>搜索: <input type="search" name=""></p>
    		<p>范围: <input type="range" name=""></p>
    		<p>时间: <input type="time" name=""></p>
    		<p>日期: <input type="date" name=""></p>
    		<p>datetime: <input type="datetime" name=""></p>
    		<p>周: <input type="week" name=""></p>
    		<p>月: <input type="month" name=""></p>
...
| **autocomplete****** | <input type="text" autocomplete="off" name="xxx”> | 规定表单是否应该启用自动完成功能  有2个值，一个是on 一个是off      on 代表记录已经输入的值  1.autocomplete 首先需要提交按钮 <br/>2.这个表单您必须给他名字 |
