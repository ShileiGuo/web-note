...
<body>
	<div>		
		...
		<img src="../images/br.gif" alt="" class="bottomIcon">
...
<html lang="en">
    ...
    <div class="ad-r"><img src="images/ad-r.png" alt="">
    </div>
    <div class="box">
...
** 因此 比如 **行内元素 如果添加了 绝对定位或者 固定定位后 或者浮动后，可以不用转换模式，直接给高度和宽度就可以了**。**
...
1. 图片和文字默认的是基线对齐，但是我们想要的是  中线对齐
2. 可以通过vertical-align 设置中线对齐
...
<head>
    ...
    div:hover {
        ...
        section img {
            transition: all 0.2s; 
            /* 因为图片缩放了， 实际图片做动画 所以过渡要给img 做动画  谁做动画，谁加过渡*/
        }
...
<head>
    ...
    img:hover {
        /*deg 度数, 默认旋转中心点时图片的中心*/
        transform: rotate(-90deg);  
        /*transform: rotate(720deg); *//* deg 度数*/
    }
...
<head>
    ...
    * {
        ...
        nav ul {
            width: 200%; /*一组ul时100%,添加2组后需要将width扩展为200%*/
...
#### 1.2.flex-direction调整主轴方向（默认为水平方向）
...
<head>
    ...
    <style>
        section {
            ...
            /*父盒子添加 flex*/
            display: flex;  /*伸缩布局模式*/
            min-width: 500px;  /*最小宽度为500px，目的保护盒子不被挤压得太厉害*/
        }
        section div {
...
<head>
    ...
    <style>
        * {
        ...
        header img {
            width: 100%;  /*继承header 的宽度， 使图片和body宽度一样*/
            height: 100%;
...
### 5. flex-flow是flex-direction、flex-wrap的简写形式
